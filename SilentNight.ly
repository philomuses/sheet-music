...
%68
	R1*3/4 | 
	g,2\p^\markup { \italic \small { rubato }} ( a4 | bes2 g8[e] |
%71
...
violin = { %Flute 2
	...
	aes2( aes4 | g2.\mf) | es4\>( g es\! | f2.\p ) |
	R1*3/4 * 3 \bar "||"
%11
	d4.(\mp es8 d4 | bes2.) | c4.( d8 c4 | bes2.) | es4( f g~ |
%16
	g f es) | d( es f | es d2) | f4( es2 | g4. f8 es4 | 
	d4. es8 d4 | bes c d8) r8 | d2( f4 | g4. d8 cis4 | c4. d8 c4 | 
%26	
	bes4.) d8(\< f[ g]\! | g2\mf g4 | c4. a8 f4 | g2. | 
...
%31
	...
	f4.( g8 f4 |
%36
	a2.) | 	a4.\f( bes8 a4 | g bes,8[ c] d[ f]) | f2( d4 | 
...
%46
	r4 r8 c( c[ bes]) | r4 r8 b8( c[ e]~ | e4 c d) | 
	r4 r8 d8( d[ bes] | c2 d8[ e]) | r4 r8 f f([ c] | es2.)\< \! |
	f,8\mp([ a] a2)_\markup { \italic \small { poco cresc. } } |
	g8([ bes] bes2) | g8([ c] c2) |
%56
	d8\mf([ e] f2) |
	a,8\mp([ d] d2)_\markup { \italic \small { poco cresc. } } |
	d8([ f] f2) | e8([ g] g2) | a4.\f( c8 d4) |r4 d8([ bes] bes4) |
	bes8([ g] f4 e) | d8\<([ f] f[ a] a[ d]\! | d2.\ff\fermata) |
	R1*3/4 * 3 | R1*3/4 |
	d,2\p^\markup { \italic \small { rubato } } ( e4 | f8[ a] g[ f] e[ c] |
%71
	c4\< f2\! | f2\> des4\!) | c\p( a f |
	f2)^\markup { \italic \small { rit. } } r4 |
	R1*3/4^\markup { \italic \small { Tempo 1 } } |
%76
	f'4.\p( g8 f4 | a2.)\< \! | es2\mf( es4 |
...
oboe = { %Flute 3
	...
	R1*3/4 | des4.\p( es8 des4 |
	f2._\markup { \italic \small { poco cresc. } } ) |
	f2( f4 | es2.\mf ) | bes4\>( es c | d2.\p) | R1*3/4 * 3 |
%11
	bes2\mp( bes4 | g2.) | a4.( bes8 a4 | g2.) | c4( d es~ |
%16	
	es d c) | bes( c d | c bes aes) | d( c2 | es4. c8 bes4 |
%21
	a4. bes8 a4 | g2 aes8) r8 | bes2(  c4 | d4. bes8 bes4 |
	a4. bes8 a4 | g4.) bes8\<( c[ d]\! | es2\mf es4 | a4. f8 c4 | d2. |
...
%31
	...
	d2.) _\markup { \italic \small { poco cresc. } } |
	d4.( es8 d4 | f2.) | f4.\f( g8 f4 | d g,8[a] bes[ d]) | d2( bes4 |
...
%46	
	a2( g4 | g2.) | c4( g a) | g2.( | e2. | f2.) | g4\<( bes a) \! |
	d,8\mp([ f] f2) _\markup { \italic \small { poco cresc. } } |
	d8([ f]) f2 | e8([ g] g2) |  8\mf([ c] d2) |
	f,8\mp([ a] a2) _\markup { \italic \small { poco decresc. } } |
	bes8([ d] d2) | c8([ e] e2) | f4.\f( g8 a4) | r4 bes8([ f] f4) |
	g8([ d] cis2) | a8\<([ d] d[ f] f[ a] \! | b2.\fermata \ff) |
	R1*3/4 * 3 | R1*3/4 |
	bes,2\p ^\markup { \italic \small { rubato } } ( c4 |
	d8[ f] e[ d] c[ bes] |
%71	
	a4\< e' es \! | d\> des bes\!) | a\p( f e |
	d2) ^\markup { \italic \small { rit. } } r4 |
	R1*3/4^\markup { \italic \small { Tempo 1 } } |
%76
	aes'4.\p( bes8 aes4 | c2.\< \!) | c2\mf( c4 |
